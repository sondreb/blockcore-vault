...
//      /// </summary>s
//      public MongoStorageOperations(MongoData storage, ILogger<MongoStorageOperations> logger, IOptions<IndexerSettings> configuration, SyncConnection syncConnection)
//      {
